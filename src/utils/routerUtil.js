...
function parseRoutes(routesConfig, routerMap) {
  ...
  routesConfig.forEach(item => {
    ...
    if (typeof item === 'string' && routerMap[item]) {
      ...
      routeCfg = {path: router.path || item, router: item, meta: router.meta}
    } else if (typeof item === 'object') {
      router = routerMap[item.router]
      routeCfg = {...item, meta: router.meta}
    }
    if (!router) {
    ...
    const route = {
      ...
      meta: {
        ...
        invisible: routeCfg.meta ? routeCfg.meta.invisible : false,
        icon: routeCfg.meta ? (routeCfg.meta.icon || '') : '',
        page: routeCfg.meta ? (routeCfg.meta.page || null) : null
      }
    }
