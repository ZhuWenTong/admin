<template>
    <a-modal v-model="visible" title="添加" ok-text="确定" cancel-text="取消" @cancel="cancel" @ok="ok" width="800px" class="dialog-ward">
        <a-form-model ref="ruleForm" :model="model" :rules="rules" labelAlign="right">
            <a-row :gutter="[40, 10]">
                <a-col :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                    <a-form-model-item has-feedback label="病房名称" prop="wardName">
                        <a-input placeholder="请输入病房名称" v-model="model.wardName" autocomplete="off" allowClear />
                    </a-form-model-item>
                </a-col>
                <a-col :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                ...
                <a-col :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                    <a-form-model-item has-feedback label="加床病房" prop="sort">
                        <a-switch v-model="model.isExtraBed"></a-switch>
                    </a-form-model-item>
                </a-col>
                <a-col :span="24">
